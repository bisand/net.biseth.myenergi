...
export class EddiDriver extends Driver {
  ...
  private _capabilities: Capability[] = [
    ...
    new Capability('heater_1_name', CapabilityType.Sensor, 18),
    new Capability('heater_2_name', CapabilityType.Sensor, 19),
    new Capability('measure_power', CapabilityType.Sensor, 20),
    new Capability('measure_power_diverted', CapabilityType.Sensor, 21),
    new Capability('meter_power_diverted', CapabilityType.Sensor, 22),
    new Capability('measure_voltage', CapabilityType.Sensor, 23),
    new Capability('measure_frequency', CapabilityType.Sensor, 24),
    new Capability('button.reset_meter', CapabilityType.Control, 25),
    new Capability('button.reset_meter_ct1', CapabilityType.Control, 26),
    new Capability('button.reset_meter_ct2', CapabilityType.Control, 27),
    new Capability('button.reset_meter_ct3', CapabilityType.Control, 28),
    new Capability('button.reset_meter_generated', CapabilityType.Control, 29),
    new Capability('button.reset_meter_diverted', CapabilityType.Control, 30),
    new Capability('button.reload_capabilities', CapabilityType.Control, 31),
    new Capability('measure_temperature.tp1', CapabilityType.Sensor, 32),
    new Capability('measure_temperature.tp2', CapabilityType.Sensor, 33),
  ];
