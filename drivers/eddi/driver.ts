...
export class EddiDriver extends Driver {
  ...
  private _capabilities: Capability[] = [
    ...
    new Capability('meter_power_ct1', CapabilityType.Sensor, 4),
    new Capability('meter_power_ct2', CapabilityType.Sensor, 5),
    new Capability('measure_power_generated', CapabilityType.Sensor, 6),
    new Capability('meter_power_generated', CapabilityType.Sensor, 7),
    new Capability('measure_power_ct1', CapabilityType.Sensor, 8),
    new Capability('measure_power_ct2', CapabilityType.Sensor, 9),
    new Capability('measure_current_ct1', CapabilityType.Sensor, 10),
    new Capability('measure_current_ct2', CapabilityType.Sensor, 11),
    new Capability('heater_1_name', CapabilityType.Sensor, 12),
    new Capability('heater_2_name', CapabilityType.Sensor, 13),
    new Capability('measure_voltage', CapabilityType.Sensor, 14),
    new Capability('measure_frequency', CapabilityType.Sensor, 15),
    new Capability('button.reset_meter', CapabilityType.Control, 16),
    new Capability('button.reset_meter_ct1', CapabilityType.Control, 17),
    new Capability('button.reset_meter_ct2', CapabilityType.Control, 18),
    new Capability('button.reset_meter_generated', CapabilityType.Control, 19),
    new Capability('button.reload_capabilities', CapabilityType.Control, 20),
  ];
