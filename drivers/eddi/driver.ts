...
export class EddiDriver extends Driver {
  ...
  private _capabilities: Capability[] = [
    ...
    new Capability('measure_voltage', CapabilityType.Sensor, 20),
    new Capability('measure_frequency', CapabilityType.Sensor, 21),
    new Capability('button.reset_meter', CapabilityType.Control, 22),
    new Capability('button.reset_meter_ct1', CapabilityType.Control, 23),
    new Capability('button.reset_meter_ct2', CapabilityType.Control, 24),
    new Capability('button.reset_meter_ct3', CapabilityType.Control, 25),
    new Capability('button.reset_meter_generated', CapabilityType.Control, 26),
    new Capability('button.reload_capabilities', CapabilityType.Control, 27),
  ];
